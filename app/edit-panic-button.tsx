    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.deleteButtonText}>Delete Panic Button</Text>
        </TouchableOpacity>
      </ScrollView>
      ...
      <CustomAlert
        ...
        type="warning"
        title="Delete Panic Button?"
        message="Are you sure you want to remove this panic button? This action cannot be undone."
        buttonText="Delete"
